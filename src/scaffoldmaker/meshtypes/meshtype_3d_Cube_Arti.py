...
class MeshType_3d_Cube_Arti(Scaffold_base):
        ...
        for e3 in range(elementsCount3):
            for e2 in range(elementsCount2):
                for e1 in range(elementsCount1):
                    ...
                    element.setNodeByIdentifier(eft, nodeIdentifiers)
    ...
    def refineMesh(cls, meshrefinement, options):
        ...
        :param options: Dict containing options. See getDefaultOptions().
        """
        refineElementsCount1 = options['Refine number of elements around']
        refineElementsCount2 = options['Refine number of elements along']
        refineElementsCount3 = options['Refine number of elements through wall']
